    ...
    <nav class="navbar navbar-expand-lg navbar-light lead fixed-top"> 
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto " style="margin: auto;">
                ...
                }  else if ($_SESSION['auth']['role'] == 30) { ?> <a class="nav-link text-white dropdown-toggle" id="personnalSpaceAdmin" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >Administrateur <span class="sr-only">(current)</span></a> 
                
                  <div class="dropdown-menu bg-light " aria-labelledby="navbarDropdown"  id="personnalSpaceAdmin">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto " style="margin: auto;">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link text-white dropdown-toggle" id="monEspaceMenu" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >Mon Espace <span class="sr-only">(current)</span></a>
                            <div class="dropdown-menu bg-light " aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="home/register/">Inscription</a>
                                <a class="dropdown-item" href="home/connect/">Connection</a>-->
                                    <!--<div class="dropdown-divider black"></div>-->
                                <!--<a class="dropdown-item <?php// !empty($futurVar['']) ? '' : 'disabled' ?>" href="#">Mon Espace</a>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" id="contactMenu" href="home/contact/">Contact <span class="sr-only">(current)</span></a>
